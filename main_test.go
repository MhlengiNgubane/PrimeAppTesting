...
func Test_isPrime(t *testing.T) {
	primeTests := []struct {
		...
		{"negetive", -1, false, "negetive numbers are not prime, by definition!"},
	}
...
func Test_prompt(t *testing.T) {
	...
	// red the output of our prompt() func from our read pipe
	out, _ := io.ReadAll(r)
...
func Test_checkNumbers(t *testing.T) {
	tests := []struct {
		...
		{name: "negative", input: "-1", expected: "negetive numbers are not prime, by definition!"},
